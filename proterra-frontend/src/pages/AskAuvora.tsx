        ...
        <CardContent className="flex-1 overflow-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center py-12">
              <Bot className="h-16 w-16 text-emerald-200 mb-4" />
                ...
                <div className="mt-6 flex flex-wrap gap-2 justify-center max-w-lg">
                  {suggestions.map((s, i) => (
                    <button
                      ...
                      className="flex items-center gap-1.5 rounded-full border bg-white px-3 py-1.5 text-sm text-zinc-600 hover:bg-zinc-50 hover:border-emerald-300 transition-colors"
                    >
